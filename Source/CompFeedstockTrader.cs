...
namespace Replimat
{
    public class CompFeedstockTrader : CompPower
    {
        ...
        public bool PowerOn
        {
            ...
            set
            {
                ...
                if (this.powerOnInt)
                {
                    ...
                    SoundDef soundDef = ((CompProperties_Power)this.parent.def.CompDefForAssignableFrom<CompFeedstockTrader>()).soundPowerOn;
                ...
                else
                {
                    ...
                    SoundDef soundDef2 = ((CompProperties_Power)this.parent.def.CompDefForAssignableFrom<CompFeedstockTrader>()).soundPowerOff;
