    ...
    public class JobDriver_LoadReplimatCorpseRecycler : JobDriver
    {
        ...
        public override IEnumerable<Toil> MakeNewToils()
        {
            ...
            toil.initAction = delegate
            {
                ...
                {
                    ThoughtDef loaderPawnThought = (pawn.story.traits.HasTrait(TraitDefOf.Psychopath) || pawn.story.traits.HasTrait(TraitDefOf.Cannibal) || pawn.Ideo?.HasHumanMeatEatingRequiredPrecept() == true || pawn.Ideo?.memes.Contains(ReplimatDef.Cannibal) == true) ? ReplimatDef.Thought_RecycledCorpseInReplimatPsychopath : Corpse.InnerPawn.IsColonist ? ReplimatDef.Thought_RecycledColonistCorpseInReplimat : ReplimatDef.Thought_RecycledStrangerCorpseInReplimat;
